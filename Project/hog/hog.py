...
def roll_dice(num_rolls, dice=six_sided):
    ...
    def multiroll(x):
        ...
        if x == 1:
            ...
            return a + multiroll(x-1)
    score = multiroll(num_rolls)
    if one_check != 0:
        return 1
    else:
        return score
...
def is_always_roll(strategy, goal=GOAL):
    ...
    a = strategy(0, 0)
    judge = True
    while score0 < goal and judge:
        score1 = 0
        while score1 < goal:
            if strategy(score0,score1) != a:
                judge = False
                break
            score1 += 1
        score0 += 1
...
def final_strategy(score, opponent_score):
    ...
    base on the sus_strategy, if in the next turn, the opponent could gain more points by
    sus_syrategy than i got, i will give up sus_strategy to roll 6 dices
    """
    # BEGIN PROBLEM 12
    return 6
    # END PROBLEM 12
